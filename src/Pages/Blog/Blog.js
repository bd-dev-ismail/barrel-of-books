  ...
  return (
    <div>
      ...
      <section className=" dark:text-gray-100">
        <div className="container flex flex-col justify-center my-10 px-4 py-8 mx-auto md:p-8">
          ...
          <div className="space-y-4 mx-auto">
            <details className="w-full lg:w-[800px] border border-primary rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 ">
                ...
                Server state URL state Local (UI) state – Local state is data we
                manage in one or another component.Local state is most often
                managed in React using the useState hook. Example: the local
                ...
                the form is disabled and the values of a form’s inputs. Global
                (UI) state – Global state is data we manage across multiple
                components. Global state is necessary when we want to get and
                update data anywhere in our app, or in multiple components at
                least. Server state – Data from an external server must be
                ...
                UI states. There are several pieces of state that must be
                managed every time you fetch or update data from an external
                server, including loading and error states. URL state – Data
            ...
            <details className="w-full lg:w-[800px] border border-primary rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 ">
                ...
                inappropriate unit testing leads to high cost Defect fixing
                during System Testing, Integration Testing and even Beta Testing
                after application is built. If proper unit testing is done in
            ...
            <details className="w-full lg:w-[800px] border border-primary rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 ">
                ...
                understanding how the front end works. <br />
